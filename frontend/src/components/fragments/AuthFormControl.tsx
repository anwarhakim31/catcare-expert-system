  ...
  return (
    <>
      <FormItem className="relative space-y-0 mt-6 ">
        ...
        <FormLabel className="absolute pointer-events-none  text-xs  text-gray-600 dark:text-gray-400 duration-300 transform -translate-y-[18px] scale-90 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-orange-600 peer-focus:dark:text-orange-600 peer-placeholder-shown:text-xs peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-90 peer-focus:-translate-y-[18px] rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">
          {label}
        </FormLabel>
        {type === "password" && (
          <button
